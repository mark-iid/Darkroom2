...
class LineBox(urwid.WidgetDecoration, urwid.WidgetWrap):
    ...
    def __init__(self,
        ...
        if light_attr:
            tlcorner, blcorner = urwid.AttrMap(urwid.Text(tlcorner),
                                               light_attr), urwid.AttrMap(
                                                   urwid.Text(blcorner),
                                                   light_attr)
        else:
            tlcorner, blcorner = urwid.Text(tlcorner), urwid.Text(blcorner)
        if dark_attr:
            trcorner, brcorner = urwid.AttrMap(urwid.Text(trcorner),
                                               dark_attr), urwid.AttrMap(
                                                   urwid.Text(brcorner),
                                                   dark_attr)
        else:
        ...
        if title_attr:
            self.title_widget = urwid.Text(
                (title_attr, self.format_title(title)))
        else:
